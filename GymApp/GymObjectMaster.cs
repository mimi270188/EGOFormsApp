...
namespace GymApp
{ 
    public class GymObjectMaster<T> where T: class
    {
        ...
        public GymObjectMaster(FrmMain frmMain, object slaveObj = null)
        {

            _Frm = new FrmMaster(typeof(T)) { Dock = DockStyle.Fill, TopLevel = false, TopMost = true, FormBorderStyle = FormBorderStyle.None };
            HideConrols(_Frm);

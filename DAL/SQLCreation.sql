...
CONSTRAINT fk_PERSON_GYMGROUP_KIND FOREIGN KEY(KINDID) REFERENCES KIND(KINDID),
CONSTRAINT u_PERSON_GYMGROUP_KIND UNIQUE(PERSONID, GYMGROUPID, KINDID)
);
...
CONSTRAINT u_DOCUMENTTYPEID_PERSONID_DOCUMENTYEAR UNIQUE(DOCUMENTTYPEID, PERSONID, DOCUMENTYEAR)
);
